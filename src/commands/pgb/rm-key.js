...
class RmKeyCommand extends BaseCommand { }

RmKeyCommand.flags = Object.assign({}, BaseCommand.flags, {
...
RmKeyCommand.aliases = ['pgb:delete-key']

RmKeyCommand.description = 'Delete the key with the specified platform and key id'

module.exports = RmKeyCommand
