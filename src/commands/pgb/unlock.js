...
UnlockCommand.flags = Object.assign({}, UnlockCommand.flags, {
...
UnlockCommand.aliases = ['pgb:unlock-key']

UnlockCommand.description = 'Unlock the signing key with the specified platform and id.'
