...
LsCommand.aliases = ['pgb:apps', 'pgb:list']

LsCommand.flags = Object.assign({}, BaseCommand.flags, {
  json: flags.boolean({char: 'j', description: 'Show raw json output'}),
  bare: flags.boolean({char: 'b', description: 'Show bare integer ids'}),
})

LsCommand.args = [{name: 'columns...'}]

LsCommand.strict = false

LsCommand.description = 'List your apps'
